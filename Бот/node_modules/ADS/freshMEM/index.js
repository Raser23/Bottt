...
function mem(id, callback) {
    var urls = require('./urls/' + id + '/urls.json').ar;
    var url;
    if (urls.length) {
...
module.exports.addF = function () {
    ...
    res['getUrl']['f'] = function (text, id) {
        sendMess(id,logUrls(loadUrls(id),id));
    };
    ...
    res['delUrl']['f']=function(text,id){
        ...
        reader(read(id,'',function(){return true},delUrl),id);
    };
...
function logUrls(u,id){
    //var u = require(__dirname + '/urls/' + id + '/urls.json')['ar'];
    var res='';
